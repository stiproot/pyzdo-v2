...
const PERSIST_TOPIC = "pyzdo_CMD_PERSIST";
const GATHER_TOPIC = "pyzdo_CMD_GATHER";
const STRUCTURE_TOPIC = "pyzdo_CMD_STRUCTURE";
const AZDO_PROXY_TOPIC = "pyzdo_CMD_AZDO_PROXY";
